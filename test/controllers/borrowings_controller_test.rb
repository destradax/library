...
class BorrowingsControllerTest < ActionController::TestCase
  ...
  test "should create borrowing" do
    assert_difference('Borrowing.count') do
      post :create, borrowing: { book_id: @borrowing.book_id, comment: @borrowing.comment, office: @borrowing.office, user_id: @borrowing.user_id }
    end
  ...
  test "should update borrowing" do
    patch :update, id: @borrowing, borrowing: { book_id: @borrowing.book_id, comment: @borrowing.comment, office: @borrowing.office, user_id: @borrowing.user_id }
    assert_redirected_to borrowing_path(assigns(:borrowing))
  end
